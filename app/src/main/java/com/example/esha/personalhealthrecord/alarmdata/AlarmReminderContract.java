package com.example.esha.personalhealthrecord.alarmdata;
...
public class AlarmReminderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.esha.personalhealthrecord.alarmdata";

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static final String PATH_VEHICLE = "reminder";
