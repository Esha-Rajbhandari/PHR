...
import com.example.esha.personalhealthrecord.reminder.AlarmScheduler;
...
public class AddAlarmActivity extends AppCompatActivity implements
    ...
    private TextView dateTxt, timeTxt, repeatTxt, noRepeatTxt, repeatTypeTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTxt = (EditText) findViewById(R.id.reminder_title);
        dateTxt = (TextView) findViewById(R.id.set_date);
        timeTxt = (TextView) findViewById(R.id.set_time);
        repeatTxt = (TextView) findViewById(R.id.set_repeat);
        noRepeatTxt = (TextView) findViewById(R.id.set_repeat_no);
        repeatTypeTxt = (TextView) findViewById(R.id.set_repeat_type);
        ...
        noRepeatTxt.setText(noRepeat);
        repeatTypeTxt.setText(repeatType);
        repeatTxt.setText("Every " + noRepeat + " " + repeatType + "(s)");

        // To save state on device rotation
        if (savedInstanceState != null) {
            String savedTitle = savedInstanceState.getString(KEY_TITLE);
            titleTxt.setText(savedTitle);
            title = savedTitle;

            String savedTime = savedInstanceState.getString(KEY_TIME);
            timeTxt.setText(savedTime);
            time = savedTime;
            ...
            repeatTxt.setText(saveRepeat);
            repeat = saveRepeat;

            String savednoRepeat = savedInstanceState.getString(KEY_REPEAT_NO);
            noRepeatTxt.setText(savednoRepeat);
            noRepeat = savednoRepeat;

            String savedRepeatType = savedInstanceState.getString(KEY_REPEAT_TYPE);
            repeatTypeTxt.setText(savedRepeatType);
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_TITLE, titleTxt.getText());
        outState.putCharSequence(KEY_TIME, timeTxt.getText());
        outState.putCharSequence(KEY_DATE, dateTxt.getText());
        outState.putCharSequence(KEY_REPEAT, repeatTxt.getText());
        outState.putCharSequence(KEY_REPEAT_NO, noRepeatTxt.getText());
        outState.putCharSequence(KEY_REPEAT_TYPE, repeatTypeTxt.getText());
    ...
    public void selectFab1(View v) {
        fab1 = (FloatingActionButton) findViewById(R.id.starred1);
        fab1.setVisibility(View.GONE);
        fab2 = (FloatingActionButton) findViewById(R.id.starred2);
        fab2.setVisibility(View.VISIBLE);
        active = "true";
    }
    ...
    public void onSwitchRepeat(View view) {
        ...
        if (on) {
            ...
            repeat = "false";
            repeatTxt.setText(R.string.repeat_off);
        }
    }
    ...
    public void setnoRepeat(View v){
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (input.getText().toString().length() == 0) {
                            ...
                            noRepeat = input.getText().toString().trim();
                            noRepeatTxt.setText(noRepeat);
                            repeatTxt.setText("Every " + noRepeat + " " + repeatType + "(s)");
                        }
                    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (titleTxt.getText().toString().length() == 0){
                    titleTxt.setError("Reminder Title cannot be blank!");
                }
...
//                 which is the {@link MainActivity}.
                ...
                // Alert the user to inform them that they have unsaved changes
    ...
    private void showUnsavedChangesDialog(
            DialogInterface.OnClickListener discardButtonClickListener) {
        // Set the action for the positive and negative listener
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
...
*/
        ...
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_REPEAT_NO, noRepeat);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_REPEAT_TYPE, repeatType);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_ACTIVE, active);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int noRepeatColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_REPEAT_NO);
            ...
            String noRepeat = cursor.getString(noRepeatColumnIndex);
